...
Furthermore, despite also increased number of active cases in the "back to school" period, the correlation between number of deaths and active cases is still not nearly as strong as they are in the "vaccinat-ing" period. Table 6, the correlation table, coincides with the findings shown in Figure 5.

Once again, the plot is showing vaccines are helping the population to fight the virus. Despite students going back to schools, infected but fully vaccinated individuals may have better surviving odds against the virus. I apologize again that due to some large number outliters, I have to zoom-in on the action part to see the relationships better.
