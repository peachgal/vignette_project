...
dec_2 <- as_tibble(dec) %>% select(Province, Confirmed, Deaths, Active, Date) 
jan_2 <- as_tibble(jan) %>% select(Province, Confirmed, Deaths, Active, Date)
feb_2 <- as_tibble(feb) %>% select(Province, Confirmed, Deaths, Active, Date)
mar_2 <- as_tibble(mar) %>% select(Province, Confirmed, Deaths, Active, Date)
apr_2 <- as_tibble(apr) %>% select(Province, Confirmed, Deaths, Active, Date)
may_2 <- as_tibble(may) %>% select(Province, Confirmed, Deaths, Active, Date)
jun_2 <- as_tibble(jun) %>% select(Province, Confirmed, Deaths, Active, Date)
jul_2 <- as_tibble(jul) %>% select(Province, Confirmed, Deaths, Active, Date)
aug_2 <- as_tibble(aug) %>% select(Province, Confirmed, Deaths, Active, Date)
sep_2 <- as_tibble(sep) %>% select(Province, Confirmed, Deaths, Active, Date)
...
lineplot3 + geom_line(lwd = 2, color = "red") + geom_point() + 
...
lineplot4 + geom_line(lwd = 2, color = "red") + geom_point() + 
